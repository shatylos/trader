...
func (d *DomainExmoMargin) GetCode() string {
	//TODO implement me
	panic("implement me")
}

func (d *DomainExmoMargin) SetConfig(m map[interface{}]interface{}) error {
	//TODO implement me
	panic("implement me")
}
...
func (d *DomainExmoMargin) GetOrder(domainId string) (structs.DomainOrder, error) {
